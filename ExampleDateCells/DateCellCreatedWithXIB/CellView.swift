...
class CellView: JTAppleDayCellView {
    ...
    let textSelectedColor = UIColor.gray
    let textDeselectedColor = UIColor.black
    let previousMonthTextColor = UIColor.white
    ...
    func setupCellBeforeDisplay(_ cellState: CellState, date: Date) {
        ...
        self.backgroundColor = cal.string(from: date) == todayDate ? todayColor:UIColorFromRGB(rgbValue: 0x125688)
